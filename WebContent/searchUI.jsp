...
String username = String.valueOf(session.getAttribute("username"));
	...
	booklist = (Vector<Book>)request.getAttribute("SSearchResult");
...
<html>
  ...
  <div style="background:url('/WebBMS/images/tushuguan.jpg');background-attachment:fixed;width:100%; height:140%;margin:0px padding-top:1px">
    ...
    <h1 align="center">小白云牌图书管理系统</h1>
		<h3 align="center">---------------查询图书----------------</h3>
		
		<form action="search" method="POST" style="margin:60px">
			<p align="center">
			<input type="text" name="SKeyword" style=" border:3px #009966 solid;width: 488px;height:29;color:#999 "placeholder="请输入关键字搜索" value=""/>	
		...
		{%>
			...
			{ %>
				...
				{%>
						...
						<td><%= booklist.get(i).author %></td> 
						<td><%= booklist.get(i).price %></td> 
						<td><%= booklist.get(i).category %></td> 
						<td><%= booklist.get(i).remark %></td> 
			   		   </tr>
